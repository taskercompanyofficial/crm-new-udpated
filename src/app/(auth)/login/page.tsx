  ...
  return (
    <form className="flex flex-col gap-6">
      ...
      <div className="grid gap-4">
        <LabelInputContainer label="Email" type="email" value={data.email} onChange={(e)=>setData("email", e.target.value)} placeholder="example@domain.com" required/>
        <LabelInputContainer label="Password" type="password" value={data.password} onChange={(e)=>setData("password", e.target.value)} placeholder="********" required/>
